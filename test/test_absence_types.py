...
def test_list_absence_types(client: Pysonio) -> None:
    absence_types: Final = client.get_absence_types()
    assert absence_types  # No empty list.


def test_get_absence_type(client: Pysonio, absence_types: list[AbsenceTypesData]) -> None:
...
def test_get_absence_types_streamed(client: Pysonio, absence_types: list[AbsenceTypesData]) -> None:
